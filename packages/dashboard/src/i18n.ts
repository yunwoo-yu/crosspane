...
const en = {
  ...
  tabNetwork: 'Network',
  tabScreen: 'Screen',
  filterTimeline: 'Filter everything',
  timelineEmpty: 'Nothing has happened yet — interact with the page',
  noMatches: 'Nothing matches',
  timelineKind: (kind: string) =>
    ({
      error: 'errors',
      console: 'logs',
      network: 'network',
  ...
  timelineKindTitle: (kind: string) => `Show or hide ${kind}`,
...
const ko: Messages = {
  ...
  tabNetwork: '네트워크',
  tabScreen: '화면',
  filterTimeline: '전체 검색',
  timelineEmpty: '아직 아무 일도 없었습니다 — 페이지를 조작해 보세요',
  ...
  timelineKindTitle: (kind) => `${kind} 보이기/숨기기`,
  filterLogs: '로그 검색',
  searchLogs: '로그 검색',
  filterUrls: 'URL 검색',
